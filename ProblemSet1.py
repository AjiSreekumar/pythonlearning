...
def problem1_7():
    ...
    hght = input("Enter the height:")
    if base1:
        floatbase1 = float(base1)
    if base2:
        floatbase2 = float(base2)
    if hght:
        floathght = float(hght)
    area = ((floatbase1+floatbase2)/2)*floathght
    print("The area of a trapezoid with bases",floatbase1,"and",end=' ')
    print(floatbase2,"and height",floathght,"is",area)
